            ...
            {isPostEdited ? (
                <>
                    ...
                    <textarea
                        ...
                        onChange={defineNewDescription}
                    ></textarea>
                    <div className={s.submit_block}>
                        <button
                            className={s.submit_edited_post}
...
const PostDropdown = (props: PostDropdownType) => {
    ...
    return (
        <div className={s.btn_more_dropdown}>
            <div className={s.dropdown_item} onClick={editPost}>
                Edit Post
            </div>
        </div>
    );
